...
resultsDirRoot="results/metrics/"

colorby="AoA_Room_ave"
...
cp $caseslistFile tmp.$caseslistFile
sed -i 's/:/,/g' tmp.$caseslistFile

# Works with both python2 and python3 
python models/mexdex/writeDesignExplorerCsv.py tmp.$caseslistFile $desiredMetricsFile $basedir output.csv $pngOutDirRoot $resultsDirRoot $outputs4DE
