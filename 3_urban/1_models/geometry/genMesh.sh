...
$run_command salome start -t -b -w 1 mesh.py args:massing.step,"water/ground/building3/building2/building1/domain/domain_ground/inlet/outlet",output,constraint.txt 2>/dev/null
